...
public class ConvertJSON {
	 ...
	 */
	public JSONObject convertToJSONF(String IPAdress){
		JSONObject obj = new JSONObject();
		List<BrainBean> brab = new ArrayList<BrainBean>();
		for(BrainBean brb:brab){
	 ...
	 */
	public void convertFromJSON(JSONObject rcvmsg){
	 ...
	 */
	public JSONObject convertToJSONS(){
		JSONObject obj = new JSONObject();
		List<BattleInfoBean> bibn = new ArrayList<BattleInfoBean>();
